let str="1304 results - 100 files								\r\n" + 
				"								\r\n" + 
				"package-lock.json:								\r\n" + 
				"   5722      },								\r\n" + 
				"   5723:     \"node_modules/domexception\": {								\r\n" + 
				"   5724        \"version\": \"1.0.1\",								\r\n" + 
				"								\r\n" + 
				"  11386          \"data-urls\": \"^1.1.0\",								\r\n" + 
				"  11387:         \"domexception\": \"^1.0.1\",								\r\n" + 
				"  11388          \"escodegen\": \"^1.11.1\",								\r\n" + 
				"								\r\n" + 
				"  15404      },								\r\n" + 
				"  15405:     \"node_modules/spdx-exceptions\": {								\r\n" + 
				"  15406        \"version\": \"2.3.0\",								\r\n" + 
				"								\r\n" + 
				"  15414        \"dependencies\": {								\r\n" + 
				"  15415:         \"spdx-exceptions\": \"^2.1.0\",								\r\n" + 
				"  15416          \"spdx-license-ids\": \"^3.0.0\"								\r\n" + 
				"								\r\n" + 
				"  17323        \"dependencies\": {								\r\n" + 
				"  17324:         \"domexception\": \"^1.0.1\",								\r\n" + 
				"  17325          \"webidl-conversions\": \"^4.0.2\",								\r\n" + 
				"								\r\n" + 
				"  21820      },								\r\n" + 
				"  21821:     \"domexception\": {								\r\n" + 
				"  21822        \"version\": \"1.0.1\",								\r\n" + 
				"								\r\n" + 
				"  25496          \"data-urls\": \"^1.1.0\",								\r\n" + 
				"  25497:         \"domexception\": \"^1.0.1\",								\r\n" + 
				"  25498          \"escodegen\": \"^1.11.1\",								\r\n" + 
				"								\r\n" + 
				"  28225      },								\r\n" + 
				"  28226:     \"spdx-exceptions\": {								\r\n" + 
				"  28227        \"version\": \"2.3.0\",								\r\n" + 
				"								\r\n" + 
				"  28233        \"requires\": {								\r\n" + 
				"  28234:         \"spdx-exceptions\": \"^2.1.0\",								\r\n" + 
				"  28235          \"spdx-license-ids\": \"^3.0.0\"								\r\n" + 
				"								\r\n" + 
				"  29503        \"requires\": {								\r\n" + 
				"  29504:         \"domexception\": \"^1.0.1\",								\r\n" + 
				"  29505          \"webidl-conversions\": \"^4.0.2\",								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"74								\r\n" + 
				"  75:     if (idetaToken !== process.env.DAJM_ACCESS_TOKEN) throw new ForbiddenException();								\r\n" + 
				"  76    }								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  38        .then(page => {								\r\n" + 
				"  39:         if (!page) throw new NotFoundException(`This page id : ${pageId} does not have any related infos`);								\r\n" + 
				"  40          return this.facebookRepository.disconnectPage(page.id, page.access_token).then(() => page);								\r\n" + 
				"								\r\n" + 
				...
				"  29        }								\r\n" + 
				"								\r\n" + 
				"  44            if (!(broadcastRes && broadcastRes.broadcast_id)) {								\r\n" + 
				"  45:             throw new BroadcastCreationException(An error occured during Broadcast creation);								\r\n" + 
				"  46            }								\r\n" + 
				"								\r\n" + 
				"  52          .catch(reqError => {								\r\n" + 
				"  53:           throw new BroadcastCreationException(get(reqError, error.error));								\r\n" + 
				"  54          });								\r\n" + 
				"								\r\n" + 
				"  74        .catch(reqError => {								\r\n" + 
				"  75:         throw new BroadcastCreationException(reqError.error.error);								\r\n" + 
				"  76        });								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"src\\features\\data-operations\\data-operations-oep.service.spec.ts:								\r\n" + 
				...
				"  1626      );								\r\n" + 
				"								\r\n" + 
				"src\\features\\data-operations\\data-operations-oop.service.spec.ts:								\r\n" + 
				"     5  import { DataComparisonsService } from ../data-comparisons/data-comparisons.service;								\r\n" + 
				"     6: import { InvalidOperationException } from ./exceptions/invalid-operation.exception;								\r\n" + 
				"     7  import { DataComparisonsStubService } from ../data-comparisons/data-comparisons.service.stub;								\r\n" + 
				"								\r\n" + 
				...
				"16								\r\n" + 
				"   17: import { InvalidOperationException } from ./exceptions/invalid-operation.exception;								\r\n" + 
				"   18  import { DataProcessorService } from ../data-processor/data-processor.service;								\r\n" + 
				"								\r\n" + 
				"   20  import { SearchOptions } from ../data-processor/interfaces/search-options.interface;								\r\n" + 
				"   21: import { InvalidDataValueException } from ../data-processor/exceptions/invalid-data-value.exception;								\r\n" + 
				"   22  import { LoggerService } from ../../core/logger/logger.service;								\r\n" + 
				"								\r\n" + 
				"  104          /* Checking Comparison parameters */								\r\n" + 
				"  105:         if (!type) throw new InvalidOperationException(\"Type dopération manquant\");								\r\n" + 
				"  106          else if (type === erase) {								\r\n" + 
				"  107            return this.dataProcessorService.eraseConversationData(context);								\r\n" + 
				"  108:         } else if (!address) throw new InvalidOperationException(\"Clé dopération manquante\");								\r\n" + 
				"  109          // stopping process to only delete a value or get current time								\r\n" + 
				"								\r\n" + 
				"  113            return this.computeOptionsOperation(dataStore, conversationData, address, type, options, operand);								\r\n" + 
				"  114:         } else if (!operand) throw new InvalidOperationException(Opérande manquant);								\r\n" + 
				"115								\r\n" + 
				"								\r\n" + 
				"  152        .catch((error: any) => {								\r\n" + 
				"  153:         if (error instanceof InvalidDataValueException) {								\r\n" + 
				"  154            this.loggerService.debug(chalk`{red.bold Real error: ${error.message} }`);								\r\n" + 
				"  155:           throw new InvalidOperationException(\"Variable dopération invalide\");								\r\n" + 
				"  156          } else throw error;								\r\n" + 
				"								\r\n" + 
				"  183            if (typeof operandValue !== string || typeof initialValue !== string) {								\r\n" + 
				"  184:             throw new InvalidOperationException(Operand or InitialValue are not valid);								\r\n" + 
				"  185            } else {								\r\n" + 
				"								\r\n" + 
				"  189            if (!(typeof operandValue === string && operandValue !== null)) {								\r\n" + 
				"  190:             throw new InvalidOperationException(Operand type is not valid);								\r\n" + 
				"  191            } else {								\r\n" + 
				"								\r\n" + 
				"  197            } else {								\r\n" + 
				"  198:             throw new InvalidOperationException(Operand type is not valid);								\r\n" + 
				"  199            }								\r\n" + 
				"								\r\n" + 
				...
				"  290            }								\r\n" + 
				"								\r\n" + 
				"  304            if (initialValue && (typeof initialValue !== object || Array.isArray(initialValue))) {								\r\n" + 
				"  305:             throw new InvalidOperationException(Selected target is not an object);								\r\n" + 
				"  306            }								\r\n" + 
				"								\r\n" + 
				"  328            } catch {								\r\n" + 
				"  329:             throw new InvalidOperationException(Unable to parse provided value);								\r\n" + 
				"  330            }								\r\n" + 
				"								\r\n" + 
				"372								\r\n" + 
				"  373:     throw new InvalidOperationException(\"Types de variables incompatibles au sein dune opération\");								\r\n" + 
				"  374    }								\r\n" + 
				"								\r\n" + 
				"  392      if (!dataStore) {								\r\n" + 
				"  393:       throw new InvalidOperationException(Data in context or in option is not valid);								\r\n" + 
				"  394      }								\r\n" + 
				"								\r\n" + 
				"  397        if (!address) {								\r\n" + 
				"  398:         throw new InvalidOperationException(Address is not valid);								\r\n" + 
				"  399        }								\r\n" + 
				"								\r\n" + 
				"  402      if (operationType !== concatenate && operationType !== formula && !options) {								\r\n" + 
				"  403:       throw new InvalidOperationException(Options manquantes);								\r\n" + 
				"  404      }								\r\n" + 
				"								\r\n" + 
				"  409        if (!options.lowerBound || !options.upperBound) {								\r\n" + 
				"  410:         throw new InvalidOperationException(Bounds are not valid);								\r\n" + 
				"  411        }								\r\n" + 
				"								\r\n" + 
				"  424        if (typeof lowerBound !== number || typeof upperBound !== number) {								\r\n" + 
				"  425:         throw new InvalidOperationException(La valeur des bornes est invalide);								\r\n" + 
				"  426        }								\r\n" + 
				"								\r\n" + 
				"  442          if (!Array.isArray(initialList)) {								\r\n" + 
				"  443:           throw new InvalidOperationException(\"La donnée a découper nest pas une liste\");								\r\n" + 
				"  444          }								\r\n" + 
				"								\r\n" + 
				"  529            if (!options.source) {								\r\n" + 
				"  530:             throw new InvalidOperationException(Source is not valid);								\r\n" + 
				"  531            }								\r\n" + 
				"								\r\n" + 
				...
				"  567            }								\r\n" + 
				"								\r\n" + 
				"  570            if (!options.source) {								\r\n" + 
				"  571:             throw new InvalidOperationException(Attributes are not valid);								\r\n" + 
				"  572            }								\r\n" + 
				"								\r\n" + 
				"  582            if (!options.separator || !options.separator.value) {								\r\n" + 
				"  583:             throw new InvalidOperationException(Separator is not valid);								\r\n" + 
				"  584            }								\r\n" + 
				"								\r\n" + 
				"  587            if (!Array.isArray(parsedObject)) {								\r\n" + 
				"  588:             throw new InvalidOperationException(Composed operation object is not a list);								\r\n" + 
				"  589            }								\r\n" + 
				"  590            if (!options) {								\r\n" + 
				"  591:             return new InvalidOperationException(Options is not valid);								\r\n" + 
				"  592            }								\r\n" + 
				"								\r\n" + 
				"  653      if (!dataStore || !operation.options) {								\r\n" + 
				"  654:       throw new InvalidOperationException(Context or option is invalid);								\r\n" + 
				"  655      }								\r\n" + 
				"								\r\n" + 
				"  703      } catch {								\r\n" + 
				"  704:       throw new InvalidOperationException(\"Erreur déxecution de la formule\");								\r\n" + 
				"  705      }								\r\n" + 
				"								\r\n" + 
				"  721      if (!Array.isArray(keyList)) {								\r\n" + 
				"  722:       throw new InvalidOperationException(Liste de clés non définie ou invalide);								\r\n" + 
				"  723      }								\r\n" + 
				"								\r\n" + 
				"  796      ) {								\r\n" + 
				"  797:       throw new InvalidOperationException(OperandValue is unknown);								\r\n" + 
				"  798      }								\r\n" + 
				"								\r\n" + 
				"  802      if (types === merge && !initialValue) {								\r\n" + 
				"  803:       throw new InvalidOperationException(initialValue is unknown);								\r\n" + 
				"  804      }								\r\n" + 
				"								\r\n" + 
				"  811      } catch (e) {								\r\n" + 
				"  812:       throw new InvalidOperationException(Date is not valid + e);								\r\n" + 
				"  813      }								\r\n" + 
				"								\r\n" + 
				"  896      if (!operandValue || !initialValue) {								\r\n" + 
				"  897:       throw new InvalidOperationException(Value Unknown);								\r\n" + 
				"  898      }								\r\n" + 
				"								\r\n" + 
				...
				"   83:           : new InvalidOperationException(\"Clé dopérande manquante\");								\r\n" + 
				"   84        }								\r\n" + 
				"								\r\n" + 
				"   91          throw options.errorType === comparison								\r\n" + 
				"   92:           ? new InvalidComparisonException(Valeur de comparateur introuvable)								\r\n" + 
				"   93:           : new InvalidOperationException(\"Valeur dopérande introuvable\");								\r\n" + 
				"   94        }								\r\n" + 
				"								\r\n" + 
				"  114        if (!keyId) {								\r\n" + 
				...
				"								\r\n" + 
				"   63      } catch (error) {								\r\n" + 
				"   64:       if (options.safeSearch && error instanceof InvalidDataValueException) {								\r\n" + 
				"   65          return options.safeValue !== undefined ? options.safeValue : error.message;								\r\n" + 
				"								\r\n" + 
				"   93      } catch (error) {								\r\n" + 
				"   94:       if (options.safeSearch && error instanceof InvalidDataValueException) {								\r\n" + 
				"   95          return { value: options.safeValue !== undefined ? options.safeValue : error.message };								\r\n" + 
				"								\r\n" + 
				"  135      } catch (error) {								\r\n" + 
				"  136:       if (error instanceof InvalidDataValueException && bypassChecks) content = { dataElem: { key: subject } };								\r\n" + 
				"  137        else throw error;								\r\n" + 
				"								\r\n" + 
				"  288      } catch (error) {								\r\n" + 
				"  289:       if (error instanceof InvalidDataValueException) return false;								\r\n" + 
				"  290        else throw error;								\r\n" + 
				"								\r\n" + 
				"  339      if (!this.isPrimitive(value)) {								\r\n" + 
				"  340:       throw new InvalidDataValueException(Valeur literale invalide);								\r\n" + 
				"  341      }								\r\n" + 
				"								\r\n" + 
				"  345        if (options.enableParsingError) {								\r\n" + 
				"  346:         throw new InvalidOperationException(Unable to parse provided value);								\r\n" + 
				"  347        }								\r\n" + 
				"								\r\n" + 
				"  384        if (!keyId) {								\r\n" + 
				"  385:         throw new InvalidDataValueException([Key not found], subject);								\r\n" + 
				"  386        }								\r\n" + 
				"								\r\n" + 
				"  392        dataElemKey = this.findElementKey(dataElem, property);								\r\n" + 
				"  393:       if (!dataElemKey) throw new InvalidDataValueException([Element not found], property);								\r\n" + 
				"  394      } else if (property && dataElem.type === object) {								\r\n" + 
				"  395        dataElemKey = this.findPropertyKey(dataElem, property);								\r\n" + 
				"  396:       if (!dataElemKey) throw new InvalidDataValueException([Property not found], property);								\r\n" + 
				"  397      }								\r\n" + 
				"								\r\n" + 
				"  419          throw options.errorType === comparison								\r\n" + 
				"  420:           ? new InvalidComparisonException(Clé de comparateur manquante)								\r\n" + 
				"  421:           : new InvalidOperationException(\"Clé dopérande manquante\");								\r\n" + 
				"  422        }								\r\n" + 
				"								\r\n" + 
				"  429          throw options.errorType === comparison								\r\n" + 
				"  430:           ? new InvalidComparisonException(Valeur de comparateur introuvable)								\r\n" + 
				"  431:           : new InvalidOperationException(\"Valeur dopérande introuvable\");								\r\n" + 
				"  432        }								\r\n" + 
				"								\r\n" + 
				"  578        const defaultValue = this.getDefaultValue(dataStoreElem, value);								\r\n" + 
				"  579:       if (defaultValue === null) throw new InvalidDataValueException([Undefined], dataStoreElem.key);								\r\n" + 
				"  580        return defaultValue;								\r\n" + 
				"								\r\n" + 
				"  597          if (dataElemKey && dataElemKey.key === length) return 0;								\r\n" + 
				"  598:         throw new InvalidDataValueException([Undefined], dataElem.key);								\r\n" + 
				"  599        } else if (!index && !dataElemKey) {								\r\n" + 
				"								\r\n" + 
				"  601        } else if (!isNaN(+index) && this.isEmpty(convValue[+index])) {								\r\n" + 
				"  602:         throw new InvalidDataValueException([Undefined], dataElem.key, null, +index);								\r\n" + 
				"  603        } else if (dataElemKey) {								\r\n" + 
				"								\r\n" + 
				"  606          } else if (typeof convValue[+index] !== object) {								\r\n" + 
				"  607:           throw new InvalidDataValueException([Undefined], dataElem.key, dataElemKey.key, +index);								\r\n" + 
				"  608          }								\r\n" + 
				"								\r\n" + 
				"  613          if (value === null) {								\r\n" + 
				"  614:           throw new InvalidDataValueException([Undefined], dataElem.key, dataElemKey.key, +index);								\r\n" + 
				"  615          }								\r\n" + 
				"								\r\n" + 
				"  623        if (defaultValue === null) {								\r\n" + 
				"  624:         throw new InvalidDataValueException([Undefined], dataElem.key, dataElemKey && dataElemKey.key);								\r\n" + 
				"  625        }								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"95								\r\n" + 
				"   96:     if (!botId || !channel || !conversationId) throw new InvalidDataPathException();								\r\n" + 
				"97								\r\n" + 
				"								\r\n" + 
				"109								\r\n" + 
				"  110:     if (!botId || !channel || !conversationId) throw new InvalidDataPathException();								\r\n" + 
				"111								\r\n" + 
				"								\r\n" + 
				...
				"  6  import { LoggerService } from ../../../core/logger/logger.service;								\r\n" + 
				"  7: import { FacebookApiLimitError, FacebookMissingTokenException } from ./exceptions/facebook-exceptions;								\r\n" + 
				"8								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  18      } else {								\r\n" + 
				"  19:       return Promise.reject(new InvalidTemplateException(\"Ce type de template nest pas supporté par le canal API\"));								\r\n" + 
				"  20      }								\r\n" + 
				"								\r\n" + 
				"  34      } else {								\r\n" + 
				...
				"								\r\n" + 
				"   71      } else {								\r\n" + 
				"   72:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"   73      }								\r\n" + 
				"								\r\n" + 
				"   83      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  170        } else {								\r\n" + 
				"  171:         return Promise.reject(new InvalidTemplateException(\"Une bulle Liste ne peut contenir quun seul bouton\"));								\r\n" + 
				"  172        }								\r\n" + 
				"								\r\n" + 
				"  198      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  383      } else {								\r\n" + 
				"  384:       return Promise.reject(new InvalidTemplateException(\"Le type dune réponse nest pas défini\"));								\r\n" + 
				"  385      }								\r\n" + 
				"								\r\n" + 
				"  392        } else {								\r\n" + 
				"  393:         return Promise.reject(new InvalidTemplateException(\"Le titre dune réponse est vide\"));								\r\n" + 
				"  394        }								\r\n" + 
				"								\r\n" + 
				"  432        } else if (!isDefaultAction) {								\r\n" + 
				"  433:         return Promise.reject(new InvalidTemplateException(\"Le titre dun bouton est vide\"));								\r\n" + 
				"  434        }								\r\n" + 
				"								\r\n" + 
				"  466          } else {								\r\n" + 
				"  467:           return Promise.reject(new InvalidTemplateException(\"LURL dun bouton est vide\"));								\r\n" + 
				"  468          }								\r\n" + 
				"								\r\n" + 
				"  492            return Promise.reject(								\r\n" + 
				"  493:             new InvalidTemplateException(\"Le bouton dappel na pas de numéro de téléphone associé\")								\r\n" + 
				"  494            );								\r\n" + 
				"								\r\n" + 
				"  504      if (element.mediaType !== image && element.mediaType !== video) {								\r\n" + 
				"  505:       return Promise.reject(new InvalidTemplateException(\"Ce type de Media nest pas géré par Facebook\"));								\r\n" + 
				"  506      } else {								\r\n" + 
				"								\r\n" + 
				"  524      } else {								\r\n" + 
				"  525:       return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  526      }								\r\n" + 
				"								\r\n" + 
				"  537        } else {								\r\n" + 
				"  538:         return Promise.reject(new InvalidTemplateException(\"Une bulle Media ne peut contenir quun seul bouton\"));								\r\n" + 
				"  539        }								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  566      } else {								\r\n" + 
				"  567:       return Promise.reject(new InvalidTemplateException(\"Le champ Titre dun élément est vide\"));								\r\n" + 
				"  568      }								\r\n" + 
				"								\r\n" + 
				...
				"  588:           new InvalidTemplateException(\"Le champ URL de laction par défaut dun des éléments est vide\")								\r\n" + 
				"  589          );								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  670      } else {								\r\n" + 
				"  671:       return Promise.reject(new InvalidTemplateException(\"Le champ URL de lélément Open Graph est vide\"));								\r\n" + 
				"  672      }								\r\n" + 
				"								\r\n" + 
				"  683        } else {								\r\n" + 
				...
				"								\r\n" + 
				"  108      } else {								\r\n" + 
				"  109:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"  110      }								\r\n" + 
				"								\r\n" + 
				"  113          if (!quickReply.title) {								\r\n" + 
				"  114:           throw new InvalidTemplateException(\"Lune des Quick Replies na pas de titre\");								\r\n" + 
				"  115          }								\r\n" + 
				"								\r\n" + 
				"  126      } else {								\r\n" + 
				...
				"  170          }								\r\n" + 
				"  171          if (!button.title) {								\r\n" + 
				"  172:           throw new InvalidTemplateException(\"Lun des boutons na pas de titre\");								\r\n" + 
				"  173          }								\r\n" + 
				"								\r\n" + 
				"  189      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  236      } else {								\r\n" + 
				"  237:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"  238      }								\r\n" + 
				"								\r\n" + 
				"  240      if (mediaElement.mediaType !== image && mediaElement.mediaType !== audio) {								\r\n" + 
				"  241:       return Promise.reject(new InvalidTemplateException(\"Ce type de Media nest pas géré par Google\"));								\r\n" + 
				"  242      } else if (mediaElement.mediaType === image) {								\r\n" + 
				"								\r\n" + 
				"  256                return Promise.reject(								\r\n" + 
				"  257:                 new InvalidTemplateException(\"Le bouton dune bulle image sur Google doit avoir un titre\")								\r\n" + 
				"  258                );								\r\n" + 
				"								\r\n" + 
				"  261                return Promise.reject(								\r\n" + 
				"  262:                 new InvalidTemplateException(\"Le bouton dune bulle image sur Google doit avoir une URL\")								\r\n" + 
				"  263                );								\r\n" + 
				"								\r\n" + 
				"  274              return Promise.reject(								\r\n" + 
				"  275:               new InvalidTemplateException(\"Le bouton dune bulle image sur Google doit être de type Ouvrir URL\")								\r\n" + 
				"  276              );								\r\n" + 
				"								\r\n" + 
				"  279        } else {								\r\n" + 
				"  280:         return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  281        }								\r\n" + 
				"								\r\n" + 
				"  298              return Promise.reject(								\r\n" + 
				"  299:               new InvalidTemplateException(								\r\n" + 
				"  300                  \"Le bouton dune bulle audio sur Google doit être de type\" +								\r\n" + 
				"								\r\n" + 
				"  306              return Promise.reject(								\r\n" + 
				"  307:               new InvalidTemplateException(\"Le bouton dune bulle audio sur Google doit avoir un titre\")								\r\n" + 
				"  308              );								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  323        } else {								\r\n" + 
				"  324:         return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  325        }								\r\n" + 
				"								\r\n" + 
				"  361      } else {								\r\n" + 
				"  362:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"  363      }								\r\n" + 
				"								\r\n" + 
				"  387          return Promise.reject(								\r\n" + 
				"  388:           new InvalidTemplateException(\"Laction par défaut dun élément de carrousel doit être de type Ouvrir URL\")								\r\n" + 
				"  389          );								\r\n" + 
				"								\r\n" + 
				"  391      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  429      } else {								\r\n" + 
				"  430:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"  431      }								\r\n" + 
				"								\r\n" + 
				"  450          return Promise.reject(								\r\n" + 
				"  451:           new InvalidTemplateException(								\r\n" + 
				"  452              \"Laction par défaut dun élément de liste doit être de \" +								\r\n" + 
				"								\r\n" + 
				"  474      } else {								\r\n" + 
				...
				"   44:         new InvalidTemplateException(\"Ce type de template nest pas supporté par Business Messages\")								\r\n" + 
				"   45        );								\r\n" + 
				"								\r\n" + 
				"   60      } else {								\r\n" + 
				...
				"								\r\n" + 
				"   74      } else {								\r\n" + 
				"   75:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"   76      }								\r\n" + 
				"								\r\n" + 
				"   86      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  100      } else {								\r\n" + 
				"  101:       return Promise.reject(new InvalidTemplateException(\"Le titre dune réponse est vide\"));								\r\n" + 
				"  102      }								\r\n" + 
				"								\r\n" + 
				"  126      } else {								\r\n" + 
				...
				"  162:       return Promise.reject(new InvalidTemplateException(\"Le titre dun bouton est vide\"));								\r\n" + 
				"  163      }								\r\n" + 
				"								\r\n" + 
				"  184        } else {								\r\n" + 
				"  185:         return Promise.reject(new InvalidTemplateException(\"LURL dun bouton est vide\"));								\r\n" + 
				"  186        }								\r\n" + 
				"								\r\n" + 
				"  197        } else {								\r\n" + 
				...
				"  221:       return Promise.reject(new InvalidTemplateException(\"Ce type de Media nest pas géré par Skype\"));								\r\n" + 
				"  222      }								\r\n" + 
				"  223      if (!mediaUrl) {								\r\n" + 
				"  224:       return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  225      }								\r\n" + 
				"								\r\n" + 
				"  267        return Promise.reject(								\r\n" + 
				"  268:         new InvalidTemplateException(\"Le format vidéo nest pas pris en charge par Google Business Messages\")								\r\n" + 
				"  269        );								\r\n" + 
				"								\r\n" + 
				"  283      } else {								\r\n" + 
				...
				"								\r\n" + 
				"   40      } else {								\r\n" + 
				"   41:       return Promise.reject(new InvalidTemplateException(\"Ce type de template nest pas supporté par Skype\"));								\r\n" + 
				"   42      }								\r\n" + 
				"								\r\n" + 
				"   51      } else {								\r\n" + 
				...
				"								\r\n" + 
				"   61      } else {								\r\n" + 
				"   62:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"   63      }								\r\n" + 
				"								\r\n" + 
				"   75      } else {								\r\n" + 
				...
				"								\r\n" + 
				"   88      } else {								\r\n" + 
				"   89:       return Promise.reject(new InvalidTemplateException(\"Le type dune réponse nest pas défini\"));								\r\n" + 
				"   90      }								\r\n" + 
				"								\r\n" + 
				"   97        } else {								\r\n" + 
				"   98:         return Promise.reject(new InvalidTemplateException(\"Le titre dune réponse est vide\"));								\r\n" + 
				"   99        }								\r\n" + 
				"								\r\n" + 
				"  123      } else {								\r\n" + 
				...
				"  157:       return Promise.reject(new InvalidTemplateException(\"Le titre dun bouton est vide\"));								\r\n" + 
				"  158      }								\r\n" + 
				"								\r\n" + 
				"  183        } else {								\r\n" + 
				"  184:         return Promise.reject(new InvalidTemplateException(\"LURL dun bouton est vide\"));								\r\n" + 
				"  185        }								\r\n" + 
				"								\r\n" + 
				...
				"  210:       return Promise.reject(new InvalidTemplateException(\"Ce type de Media nest pas géré par Skype\"));								\r\n" + 
				"  211      }								\r\n" + 
				"  212      if (!mediaUrl) {								\r\n" + 
				"  213:       return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  214      }								\r\n" + 
				"								\r\n" + 
				"  248        if (template.elements[0].buttons && template.elements[0].buttons.length > 0) {								\r\n" + 
				"  249:         return Promise.reject(new InvalidTemplateException(\"Les vidéos nacceptent pas de bouton sur Skype\"));								\r\n" + 
				"  250        } else {								\r\n" + 
				"								\r\n" + 
				...
				"   58:         new InvalidTemplateException(\"Une bulle de réponse rapide doit avoir un texte dintroduction\")								\r\n" + 
				"   59        );								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"   77      if (!text) {								\r\n" + 
				"   78:       return Promise.reject(new InvalidTemplateException(\"Un bouton doit avoir un texte dintroduction\"));								\r\n" + 
				...
				"								\r\n" + 
				"  133      } else {								\r\n" + 
				"  134:       return Promise.reject(new InvalidTemplateException(\"Le texte dintroduction est vide\"));								\r\n" + 
				"  135      }								\r\n" + 
				"								\r\n" + 
				"  145      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  224        } else {								\r\n" + 
				"  225:         return Promise.reject(new InvalidTemplateException(\"Une bulle Liste ne peut contenir quun seul bouton\"));								\r\n" + 
				"  226        }								\r\n" + 
				"								\r\n" + 
				"  250      } else {								\r\n" + 
				...
				"								\r\n" + 
				"  436      } else {								\r\n" + 
				"  437:       return Promise.reject(new InvalidTemplateException(\"Le type dune réponse nest pas défini\"));								\r\n" + 
				"  438      }								\r\n" + 
				"								\r\n" + 
				"  445        } else {								\r\n" + 
				"  446:         return Promise.reject(new InvalidTemplateException(\"Le titre dune réponse est vide\"));								\r\n" + 
				"  447        }								\r\n" + 
				"								\r\n" + 
				"  481        } else if (!isDefaultAction) {								\r\n" + 
				"  482:         return Promise.reject(new InvalidTemplateException(\"Le titre dun bouton est vide\"));								\r\n" + 
				"  483        }								\r\n" + 
				"								\r\n" + 
				"  515          } else {								\r\n" + 
				"  516:           return Promise.reject(new InvalidTemplateException(\"LURL dun bouton est vide\"));								\r\n" + 
				"  517          }								\r\n" + 
				"								\r\n" + 
				"  541            return Promise.reject(								\r\n" + 
				"  542:             new InvalidTemplateException(\"Le bouton dappel na pas de numéro de téléphone associé\")								\r\n" + 
				"  543            );								\r\n" + 
				"								\r\n" + 
				"  553      if (element.mediaType !== image && element.mediaType !== video) {								\r\n" + 
				"  554:       return Promise.reject(new InvalidTemplateException(\"Ce type de Media nest pas géré par Facebook\"));								\r\n" + 
				"  555      } else {								\r\n" + 
				"								\r\n" + 
				"  570      } else {								\r\n" + 
				"  571:       return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  572      }*/								\r\n" + 
				"								\r\n" + 
				"  581        } else {								\r\n" + 
				"  582:         return Promise.reject(new InvalidTemplateException(\"Une bulle Media ne peut contenir quun seul bouton\"));								\r\n" + 
				"  583        }								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  610      } else {								\r\n" + 
				"  611:       return Promise.reject(new InvalidTemplateException(\"Le champ Titre dun élément est vide\"));								\r\n" + 
				"  612      }								\r\n" + 
				"								\r\n" + 
				...
				"  632:           new InvalidTemplateException(\"Le champ URL de laction par défaut dun des éléments est vide\")								\r\n" + 
				"  633          );								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  712      } else {								\r\n" + 
				"  713:       return Promise.reject(new InvalidTemplateException(\"Le champ URL de lélément Open Graph est vide\"));								\r\n" + 
				"  714      }								\r\n" + 
				"								\r\n" + 
				"  723        } else {								\r\n" + 
				...
				"								\r\n" + 
				"  27      } else {								\r\n" + 
				"  28:       return Promise.reject(new InvalidTemplateException(\"Ce type de template nest pas supporté par Whatsapp\"));								\r\n" + 
				"  29      }								\r\n" + 
				"								\r\n" + 
				"  38      } else {								\r\n" + 
				...
				"  55:       return Promise.reject(new InvalidTemplateException(\"Ce type de Media nest pas géré par Whatsapp\"));								\r\n" + 
				"  56      }								\r\n" + 
				"  57      if (!mediaUrl) {								\r\n" + 
				"  58:       return Promise.reject(new InvalidTemplateException(\"LURL du media est vide\"));								\r\n" + 
				"  59      }								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  44        .catch(error => {								\r\n" + 
				"  45:         if (error instanceof DoNothingException) res.sendStatus(200);								\r\n" + 
				"  46          else next(error);								\r\n" + 
				"								\r\n" + 
				...
				"								\r\n" + 
				"  32      if (googleSignature !== generatedSignature) {								\r\n" + 
				"  33:       return Promise.reject(new DoNothingException(Signature mismatch));								\r\n" + 
				"  34      }								\r\n" + 
				"								\r\n" + 
				"  65        return new Promise((resolve, reject) => {								\r\n" + 
				"  66:         if (!text) reject(new DoNothingException(Empty text));								\r\n" + 
				"  67          newContext.message = new IncomingMessage({ type: text, text });								\r\n" + 
				"								\r\n" + 
				...
				"src\\resources\\nodes\\nodes.repository.ts:								\r\n" + 
				"4								\r\n" + 
				"   5: import { NodeNotFoundException } from ./exceptions/node-not-found.exception;								\r\n" + 
				"   6: import { BotNotFoundException } from ../bots/exceptions/bot-not-found.exception;								\r\n" + 
				"   7  import { FirebaseRef, FirebaseSnap } from ../../core/providers/firebase-db.provider;								\r\n" + 
				"								\r\n" + 
				"  72          if (!snap.exists()) {								\r\n" + 
				"  73:           throw nodeId === noeud_0 ? new BotNotFoundException(botId) : new NodeNotFoundException(nodeId);								\r\n" + 
				"  74          }								\r\n" + 
				"								\r\n" + 
				"src\\resources\\nodes\\nodes.service.ts:								\r\n" + 
				...
				"   77:         if (!url) throw new InvalidApiConfigException(\"Lurl de lAPI est vide\");								\r\n" + 
				"78								\r\n" + 
				"								\r\n" + 
				...
				"  127                  }								\r\n" + 
				"  128:                 throw new InvalidApiConfigException(\"La structure de stockage na pas été définie\");								\r\n" + 
				"  129                }								\r\n" + 
				"  130:               throw new InvalidApiConfigException(La clé de stockage est invalide);								\r\n" + 
				"  131              });								\r\n" + 
				"  132            }								\r\n" + 
				"  133:           throw new InvalidApiConfigException(\"La clé de stockage na pas été définie\");								\r\n" + 
				"  134          }								\r\n" + 
				"								\r\n" + 
				"  141            : Promise.reject(								\r\n" + 
				...
				"  220            \"Une erreur sest produite lors du stockage de la réponse dans une chaîne de caractère\"								\r\n" + 
				"								\r\n" + 
				"  239        return Promise.reject(								\r\n" + 
				"  240:         new InvalidApiMappingException(\"Une erreur sest produite lors de la lecture des valeurs dans la réponse\")								\r\n" + 
				"  241        );								\r\n" + 
				"								\r\n" + 
				"  273      } catch (error) {								\r\n" + 
				...
				"  4    constructor(message = \"La requête a échoué, je le savais quelle allait échouer !\") {								\r\n" + 
				"								\r\n" + 
				...
				"  4    constructor(message = \"Un paramètre de configuration à provoqué une erreur lors de lenvoi vers une API\") {								\r\n" + 
				"								\r\n" + 
				...
				"  4    constructor(message = \"La réponse na pas pu être stockée dans les données du bot\") {								\r\n" + 
				"								\r\n" + 
				...
				"  6    constructor(message = \"Un paramètre de configuration est invalide dans la bulle dopérations\") {								\r\n" + 
				"								\r\n" + 
				...
				"   1: import { ForbiddenException, Inject, Injectable, UnauthorizedException } from @nestjs/common;								\r\n" + 
				"2								\r\n" + 
				"								\r\n" + 
				"  20            ? Promise.resolve(user)								\r\n" + 
				"  21:           : Promise.reject(new ForbiddenException(User is not authorized to execute this action))								\r\n" + 
				"  22        )								\r\n" + 
				"								\r\n" + 
				"  24          if (error && error.code === auth/argument-error) {								\r\n" + 
				"  25:           throw new UnauthorizedException();								\r\n" + 
				"  26          }								\r\n" + 
				"";
let strarray=str.split("\n");

let strarray2=strarray.filter(x=>x.indexOf(":")!==-1||x.indexOf("src")===0);
strarray2.forEach(element => {
    if(element.indexOf("src")===0){
        console.log(element);
    }
